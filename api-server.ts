...
// Safe compiler sandbox endpoint to execute standard snippets online
...
app.post("/api/evaluate", async (req, res) => {
  ...
  try {
    ...
    const response = await client.models.generateContent({
      ...
      contents: prompt,
      config: {
        systemInstruction: `You are NovaBot, a friendly and encouraging AI coding mentor on the gamified learning app CodeNova. Your tone is playful, clear, using high-quality short tips just like Duolingo. Explain mistakes directly in simple student-friendly language. Always populate the required schema fields.`,
